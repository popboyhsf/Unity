...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    //facebook 添加测试设备，
    [FBAdSettings addTestDevice:@"476ce215ef003beb44480b2de43a1225d19ff657"];
    // Override point for customization after application launch.
    [AppsFlyerProxy instanceInitWithKey:@"SFmpoiTG8y4MzCSPePPpsP" appId:@"1481748722" gameName:@"fishingfantasy" delegate:self];
    AdId * adId = [AdId new];
    
    
    //测试ID
		adId.mAdmobAppId = @"ca-app-pub-3940256099942544~1458002511";
		adId.AdmobIdSplash = @[@"ca-app-pub-3940256099942544/4411468910"];
		adId.AdmobIdNextLevel = @[@"ca-app-pub-3940256099942544/4411468910"];
		adId.AdmobIdResume = @[@"ca-app-pub-3940256099942544/4411468910"];
		adId.AdmobIdVideo = @"ca-app-pub-3940256099942544/1712485313";

		adId.fbUnitIdVideo = @"PLAYABLE#YOUR_PLACEMENT_ID";
		adId.fbIdResume = @[@"PLAYABLE#YOUR_PLACEMENT_ID"];
		adId.fbIdSplash = @[@"PLAYABLE#YOUR_PLACEMENT_ID"];
		adId.fbNextLevel = @[@"PLAYABLE#YOUR_PLACEMENT_ID"];

		adId.unityIdResume = @[@"video"];
		adId.unityIdSplash = @[@"defaultZone"];
		adId.unityIdNextLevel = @[@"defaultVideoAndPictureZone"];
		adId.unityGameID = @"14850";
		adId.unityUnitIdVideo = @"rewardedVideo";
    
    
    
    [AdManager instanceInitWithAdId:adId testMode:false delegate:self];
    [AdManager.getInstance showInterstitialWithType:InterstitialEnum::InterstitialEnumSplashEnd];
    
    AdManager.getInstance.showLog = true;
