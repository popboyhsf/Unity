...
namespace Mkey
{
    public class TweenSeqRun
    {
        ...
        Queue<Action<Action>> seql=new Queue<Action<Action>>();
        Action complCallBack;
        bool breakSeq = false;
        
        public void Add(Action<Action> tweenAction)
        {
            seql.Enqueue(tweenAction);
        }

        public void AddAndRun(Action<Action> tweenAction)
        {
            seql.Enqueue(tweenAction);
            if (IsComplete)
            {
        ...
        public void Start(Action complete = null)
        {
