...
public class CreatBezier2D
{
    ...
    public CreatBezier2D(GameObject obj, float xOffset, float yOffset, int vertexCount)
    {
        ...
        positions.Add(new Vector3(obj.transform.position.x + xOffset, obj.transform.position.y + yOffset, obj.transform.position.z ));
        positions.Add(new Vector3(obj.transform.position.x - xOffset, obj.transform.position.y + yOffset, obj.transform.position.z ));
        positions.Add(new Vector3(obj.transform.position.x, obj.transform.position.y + yOffset * 2, obj.transform.position.z));
